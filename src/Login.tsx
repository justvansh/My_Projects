...
class Form extends Component<Props, State> {
  ...
  handleInp = (e:any):void=> {
    ...
    const { userName,Email,Address,Password, Data } = this.state;
    const newData = { 
      userName: userName,
      Email: Email,
      Address: Address,
  ...
  render() {
    ...
    const { userName, Email, Address, Password,Obj,Data } = this.state;

    return (
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', width: '100vw', justifyContent: 'center', alignItems: 'center' }}>
        <h1>ZenQua</h1>
        <div className={classes.root}>
          <TextField id="outlined-basic" label="Enter Name" variant="outlined" name="Name" value={userName} onChange={this.handleInputChange}/>
        </div>
        {/* <div className={classes.root}>
